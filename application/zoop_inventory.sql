...
CREATE TABLE IF NOT EXISTS `consignments` (
  `consignment_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `consignments_detail`
--

CREATE TABLE IF NOT EXISTS `consignments_detail` (
...
CREATE TABLE IF NOT EXISTS `products` (
  ...
  `febric` varchar(20) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `settings` (
  ...
  `febrics` text,
  `theme_name` varchar(20) DEFAULT 'theme-1-active',
  `theme_primary_color` varchar(20) NOT NULL DEFAULT 'pimary-color-red',
  `tags` text NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `tags` (`tag_id`, `tag_name`, `create_date`) VALUES
(1, 'a', '2018-04-02 06:24:53'),
(2, 'b', '2018-04-02 06:24:53');
